...
document.getElementById('input').addEventListener('keydown', function(event) {
	if (event.key === 'Enter') {
		...
		if (command === 'help') {
			...
			const color_ex = createText("ex: color red, color default, color #56603d, color rgb(214, 122, 127), color hsl(30deg 82% 43%)");
			...
			const Morpion = createProject('https://github.com/DJ4nto/Morpion', 'none', 'Morpion', 'Tic Tac Toe game made with Python');
